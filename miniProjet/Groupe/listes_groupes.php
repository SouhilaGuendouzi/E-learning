    ...
    if (!empty($login)&&(!empty($pass))){
        try {
            ...
            <?php
             ...
             <div id="d1">
             <h3> Informations sur le Groupe à Ajouter </h3>
             ...
             <div class="control-group">
              ...
              <div class="control-group">
                   ...
                   <?php 
                    $req4=$pdo->prepare("select * from elearn.niveau naturel join elearn.année natural join elearn.spécialité ");
                    $req4->execute();
                    while ($result4 = $req4->fetch(PDO::FETCH_ASSOC))
                    {
                   ?> <option value="<?php echo $result4["id_niv"];?>"><?php echo $result4["année"]."année  ".$result4["nom"];?></option>
                        <?php
                    }
                   ?> 
                   </select>               
